...
Authenticated users SHALL configure which LLM provider and model Core uses for inbound progress parsing, via the settings page, without receiving API keys in the browser.
